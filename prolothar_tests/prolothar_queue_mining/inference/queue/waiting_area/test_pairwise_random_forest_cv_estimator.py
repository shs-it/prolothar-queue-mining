...
from prolothar_queue_mining.inference.queue.waiting_area import PairwiseRandomForestCvEstimator

class TestPairwiseRandomForestCvEstimator(unittest.TestCase):

    def test_infer_with_one_server(self):
        waiting_area_inference = PairwiseRandomForestCvEstimator(['a', 'b', 'c'], ['x', 'y', 'z'])
        ...
        self.assertIn('PQ(RandomForest', discovered_waiting_area.get_discipline_name())
